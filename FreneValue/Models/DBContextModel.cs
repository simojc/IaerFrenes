...
namespace FreneValue.Models
{
    ...
    public class arbredb : DbContext
    {
        ...
        public DbSet<COD_DOM> domaines { get; set; }
      ...
      .ToTable("errorlog");
            ...
            modelBuilder.Entity<COD_DOM>().Property(r => r.DESCRIP).HasColumnName("descrip");
            modelBuilder.Entity<COD_DOM>().Property(r => r.DT_CRETN).HasColumnName("dt_cretn");
            modelBuilder.Entity<COD_DOM>().Property(r => r.DT_MODF).HasColumnName("dt_modf");
            modelBuilder.Entity<COD_DOM>().Property(r => r.UTIL).HasColumnName("util");
            modelBuilder.Entity<COD_DOM>().Property(r => r.ACTIF).HasColumnName("actif");

            // TABLE VAL_DOM
            modelBuilder.Entity<VAL_DOM>().Property(r => r.ID).HasColumnName("id");
            modelBuilder.Entity<VAL_DOM>().Property(r => r.COD_DOM).HasColumnName("code_dom");
            modelBuilder.Entity<VAL_DOM>().Property(r => r.COD_VAL).HasColumnName("code_val");
